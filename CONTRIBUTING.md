# Contributing to Movabel

Thank you for your interest in contributing to Movabel! This document provides guidelines and instructions for contributing.
...
```bash
git clone https://github.com/YOUR_USERNAME/movabel.git
cd movabel
...
This builds the CPU sidecar (bundled with the app), the CUDA binary (placed in `%APPDATA%/www.movabel.ai/backends/` for runtime GPU switching), and the installable Tauri app.
...
Thank you for contributing to Movabel! 🎉
