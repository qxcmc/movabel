...
and respects the MOVABEL_CORS_ORIGINS environment variable.
...
class TestCORSCustomOrigins:
    """MOVABEL_CORS_ORIGINS env var should extend the allowlist."""
...
class TestCORSEnvVarParsing:
    """Edge cases for MOVABEL_CORS_ORIGINS parsing."""
