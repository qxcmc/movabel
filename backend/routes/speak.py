"""POST /speak — REST wrapper around movabel.speak for non-MCP callers.
...
bindings (via X-Movabel-Client-Id) work identically.
"""
...
async def speak(
    ...
    """Speak text in a voice profile. Mirrors movabel.speak (MCP).
    ...
    if profile is None:
        ...
        raise HTTPException(
            ...
            detail=(
                ...
                "or configure a default in Movabel → Settings → MCP."
            ),
        )
