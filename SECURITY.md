...
2. Email security details to: [security@movabel.sh](mailto:security@movabel.sh)
3. Include:
...
- **Keep Movabel updated** - Updates include security patches
...
Movabel processes all audio locally by default. Your voice data never leaves your machine unless you explicitly enable remote server mode.
...
Thank you for helping keep Movabel secure! 🔒
