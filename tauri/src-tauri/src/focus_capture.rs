...
//! Movabel itself" and short-circuit the synthetic-paste path. On
//! Windows, `bundle_id` holds the lowercased exe basename (`"movabel.exe"`)
...
mod win {
    ...
    /// (e.g. `"movabel.exe"`). This is the Windows analogue of macOS'
